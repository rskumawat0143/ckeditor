// ckeditor plugin for WonderCMS, JavaScript
(function (factory) {
    ...
    $.extend($.ckeditor.plugins, {
      files: function (context) {
        ...
        self.initialize = function () {
          ...
          var body =
            '<div class="form-group row-fluid" id="filesDialog">' +
            ...
            "</div>";
          var footer =
            '<button href="#" class="btn btn-primary ext-files-btn">Insert</button>';
  
          self.$dialog = ui
            .dialog({
              title:
                "Insert image or document (Copy link to file Settings -> Files)",
        ...
        self.openDialog = function (t) {
          ...
          return $.Deferred(function (deferred) {
            ...
            ui.onDialogShown(self.$dialog, function () {
              ...
              $dialogBtn.click(function (event) {
